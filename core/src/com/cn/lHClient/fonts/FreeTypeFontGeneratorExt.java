...
public class FreeTypeFontGeneratorExt implements Disposable {
	...
	public BitmapFont init(int size, boolean flip) {
	...
	public FreeTypeBitmapFontData appendData() {
...
//				if (second == null)
//					continue;
//				int kerning = FreeType.getKerning(face,
//						FreeType.getCharIndex(face, firstChar),
//						FreeType.getCharIndex(face, secondChar), 0);
//				if (kerning == 0)
//					continue;
//				first.setKerning(secondChar, FreeType.toInt(kerning));
